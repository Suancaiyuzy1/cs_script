...
// by 凯岩城的狼
const HITBOX_NAME = "lv2_boss_hitbox_2"; // func_physbox 的 targetname
const BOSS_BAR_NAME = "lv2_boss_hp_bar"; // env_particle_glow 的 targetname

// 配置：数值规则
const BASE_HP = 6000; // 初始基础血量
const CT_BONUS = 1000; // 每个存活 CT 增加
