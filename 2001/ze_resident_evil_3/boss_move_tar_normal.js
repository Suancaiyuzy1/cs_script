...
Instance.OnScriptInput("SetSpeedX1.5", ({ caller, activator }) => {
    SPEED_FORWARD *= 1.5;
});
...
Instance.OnScriptInput("Start", () => {
	if(!ticking)
	{
        ...
        SetEntities();
	    ticking = true;
		Instance.EntFireAtName({ name: boss_script_ent, input: "runscriptinput", value: "Tick", delay: TICKRATE = 0.1 });
	}
});
